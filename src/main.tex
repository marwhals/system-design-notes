...
%TODO where does pine cone and vector data bases fit in...........
    ...
    Usualy cheap and used for specific use cases.
...
%    \end{itemize}
    ...
    --- Thats because open connections to other services consume system resources and can directly impact the microservice performance.
    ...
    When the initial reqeust is being made we generate a uniqe trace ID and place it into an object called a trace context
    ...
    - Need to run an agent on each microservice host which consumes its own CPU and memeory
    ...
    - Considering scala most companies use sampling on the client side which may mean we get one trace out of 10,000 or 1000 reqeusts.
    -- this can lower our storage costs but with such a high sampling ratio sometimes it maeks it difficult to find a trace we are trying to debug.
    ...
    Despite the challenges distrbuted tracing is very useful when debugging microservices.
    Help developer have the confidence to debug issues in prodction, find the root cause.
