...
%    TODO add more details maybe????
    ...
    \paragraph{Dedicated Hosts and Single Teneant Virtual Machine Cloud Services}
    \begin{itemize}
        \item Amazon Dedicated EC2 Instances
        \item Amazon EC2 Dedicated Hosts
        \item GCP Sole-Tenant Node
        \item Microsfot Azure Dedicated Hosts
    \end{itemize}
    ...
    \subsection{Containers for Microservices using Function as a Service}
    ...
    \subsection{Container Orchestration and Kubernetes for Microservices Architectureó}
