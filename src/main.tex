...
%    Add equation
    ...
    This is achieved by accompanying a state representation reasoner to the client with hyper mediat links.
    The client can follow these links ad progress its internal state.
    ...
    Use nouns only.
    Provides distinction between actions and the resources the actions will be take on.
